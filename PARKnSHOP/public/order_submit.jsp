...
Commodity commodity=(Commodity)session.getAttribute("commodity");
 ...
 Order order=new Order(0,customer.getUserNameC(),commodity.getProductname(),commodity.getShopname(),quantity,commodity.getPrice());
...
<td width="100px"><b>$${commodity.price}</td>
<td width="100px"><b>${quantity}</td>
<td width="100px"><b>$${quantity*commodity.price}</td>
</tr>
