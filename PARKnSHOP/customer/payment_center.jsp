...
background: #b1d6f1; 
 ...
 <body>
  ...
  <tr>
  <td width="800px" valign=center align=center></td>
  <%
  ...
  %>
  <td width="300px" valign=center align=right><font color="Red">Dollar: <%=price%></font><td>
  </tr>
  </table>
  </td>
  </tr>
  ...
  <tr>
  <td width="200px">&nbsp;</td>
  <td> <input type="radio" name="bank" value="b1" /> <img src="../public/images/23.jpg" style="height:40px;"/></td>
  <td width="50px">&nbsp;</td>
   <td> <input type="radio" name="bank" value="b2" /> <img src="../public/images/24.jpg" style="height:40px;"/></td>
 <td width="50px">&nbsp;</td>
   <td> <input type="radio" name="bank" value="b3" /> <img src="../public/images/25.jpg" style="height:40px;"/></td>
  </tr>
  <tr>
  <td width="200px">&nbsp;</td>
  <td> <input type="radio" name="bank" value="b4" /> <img src="../public/images/26.jpg" style="height:40px;"/></td>
 <td width="50px">&nbsp;</td>
   <td> <input type="radio" name="bank" value="b5" /> <img src="../public/images/27.jpg" style="height:40px;"/></td>
 <td width="50px">&nbsp;</td>
   <td> <input type="radio" name="bank" value="b6" /> <img src="../public/images/28.jpg" style="height:40px;"/></td>
  </tr>
  </table>
  </td>
  </tr>
