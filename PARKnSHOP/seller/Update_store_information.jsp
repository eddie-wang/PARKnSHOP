...
<html lang="en">
 <head>
  ...
  <title>Update_store_information</title>
...
<tr>
	<td bgcolor="#1B3F94"><font  size="5" color="#FFFFFF">Store name</font></td>
	<td align="left" >${seller.store.shopname}</td>
</tr>

<tr>
	<td bgcolor="#1B3F94"><font  size="5" color="#FFFFFF">Store type</font></td>
	<td align="left" ><div>
...
<tr>
	<td bgcolor="#1B3F94"><font  size="5" color="#FFFFFF">Email</font></td>
	<td align="left"><input type="text" style="width:300px;" name="email" value="${seller.email}" id="email"></td>
</tr>


<tr>
	<td bgcolor="#1B3F94"><font  size="5" color="#FFFFFF">Telephone</font></td>
	<td align="left"><input type="text" style="width:300px" name="telephone" value="${seller.telephone } " id="tele"> </td>
</tr>
...
<td align="left">
<input type="submit" value="save" class="button b" onclick="return submitI()">
</td>
</table>
